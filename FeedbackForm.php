...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['recaptcha_response'])) {
    ...
    $recaptcha_secret = '6Le1ht0mAAAAAM3eK8CUH79u57_5tKpTPxy-DmX5';
    ...
    if ($recaptcha->score > 0.7) {
        try {
            ...
            //$from = '';
            $to = "theqhotel.vizag@gmail.com";

            $subject = "Inquiry - The Q Hotel " . $name;
            ...
            $body .=
                "<td width=40% colspan=3 align=center style='background:" .
                $fromcolor .
                "; padding-top:10px; padding-bottom: 0px; border-bottom: 1px solid " .
                $fromcolor .
                "; color:#fff;'>
